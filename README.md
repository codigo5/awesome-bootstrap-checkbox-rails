...
A simple gem that seamlessly includes stylesheets from the original [Awesome Bootstrap Checkbox](https://github.com/flatlogic/awesome-bootstrap-checkbox).
...
Simply add `*= require awesome-boostrap-checkbox` to your stylesheet manifest.
